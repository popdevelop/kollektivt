...
line = Line.objects.create(name="31")
grab_station(line, "Malmö Värnhem")
grab_station(line, "Malmö Ellstorp")
grab_station(line, "Malmö Katrinelund")
grab_station(line, "Malmö Industrigatan")
grab_station(line, "Malmö Stenkulaskolan")
grab_station(line, "Malmö Annelund")
grab_station(line, "Malmö Emilstorp")
grab_station(line, "Malmö Rosengård")
grab_station(line, "Malmö Rosengård Centrum")
grab_station(line, "Malmö Ramels väg")
grab_station(line, "Malmö Västra Skrävlinge")
grab_station(line, "Malmö Almgården")
grab_station(line, "Malmö Jägersro Villastad")
grab_station(line, "Malmö Travbanan")
grab_station(line, "Malmö Jägersro")
grab_station(line, "Malmö Jägershill")
grab_station(line, "Malmö Skrittgatan")
grab_station(line, "Malmö Elisedal")
grab_route(line)
grab_directions(line)

#line = Line.objects.create(name="33")
#grab_station(line, "Malmö Värnhem")
#grab_station(line, "Malmö Östervärn")
#grab_station(line, "Malmö Kirsebergsskolan")
#grab_station(line, "Malmö Sjölundaviadukten")
#grab_station(line, "Malmö Östra Fäladsgatan")
#grab_station(line, "Malmö Östra Fäladen")
#grab_station(line, "Malmö Simrisbanvägen")
#grab_station(line, "Malmö Vattenverksvägen")
#grab_station(line, "Malmö Höjdrodergatan")
#grab_station(line, "Malmö Flygvärdinnan")
#grab_station(line, "Malmö Flygledaren")
#grab_station(line, "Malmö Mölledalsskolan")
#grab_station(line, "Malmö Ulricedal")
#grab_station(line, "Malmö Dalvik")
#grab_station(line, "Malmö Videdal")
#grab_station(line, "Malmö Videdals torg")
#grab_station(line, "Malmö Ellenborgsvägen")
#grab_station(line, "Malmö Höja")
#grab_station(line, "Malmö Almgården")
#grab_station(line, "Malmö Jägersro Villastad")
#grab_station(line, "Malmö Travbanan")
#grab_station(line, "Malmö Jägersro")
#grab_station(line, "Malmö E-center")
#grab_station(line, "Malmö Agnesfrids Gymnasium")
#grab_station(line, "Malmö Bronsyxegatan")
#grab_station(line, "Malmö Järnyxegatan")
#grab_station(line, "Malmö Stenyxegatan")
#grab_station(line, "Malmö Fosieby")
#grab_station(line, "Malmö Lindängsstigen")
#grab_station(line, "Malmö Vårsången")
#grab_station(line, "Malmö Lindängen")
#grab_station(line, "Malmö Tenorgatan")
#grab_station(line, "Malmö Almvik")
#grab_station(line, "Malmö Nornegatan")
#grab_station(line, "Malmö Syd Svågertorp")
#grab_station(line, "Malmö Svågertorpsparken")
#grab_station(line, "Malmö Stolpalösa")
#grab_station(line, "Malmö Aktrisgatan")
#grab_station(line, "Malmö Fosieborg")
#grab_station(line, "Malmö Konsultgatan")
#grab_station(line, "Malmö Ärtholmen")
#grab_station(line, "Malmö Bellevuegården")
#grab_station(line, "Malmö Gamlegård")
#grab_station(line, "Malmö Rudbecksgatan")
#grab_station(line, "Malmö Högestadsgatan")
#grab_station(line, "Malmö Bispgatan")
#grab_station(line, "Malmö Djupadal")
#grab_station(line, "Malmö Högbo")
#grab_station(line, "Malmö Limhamns kyrka")
#grab_station(line, "Malmö Östanväg")
#grab_station(line, "Malmö Grönalund")
#grab_station(line, "Malmö Öresundsgården")
#grab_station(line, "Malmö Limhamn Centrum")
#grab_station(line, "Malmö Limhamns torg")
#grab_station(line, "Malmö Stranden")
#grab_station(line, "Malmö Prångaregatan")
#grab_station(line, "Malmö Ön")
#grab_route(line)
#grab_directions(line)

line = Line.objects.create(name="34")
grab_station(line, "Malmö Värnhem")
grab_station(line, "Malmö Celsiusgatan")
grab_station(line, "Malmö S:t Pauli kyrka")
grab_station(line, "Malmö Disponentgatan")
grab_station(line, "Malmö Konserthuset")
grab_station(line, "Malmö Barkgatan")
grab_station(line, "Malmö Möllevångstorget")
grab_station(line, "Malmö Södervärn")
grab_station(line, "Malmö Dalaplan")
grab_station(line, "Malmö Mobilia")
grab_station(line, "Malmö Södertorp")
grab_station(line, "Malmö Isstadion")
grab_station(line, "Malmö Hålsjögatan")
grab_station(line, "Malmö Bellevueallén")
grab_station(line, "Malmö Bellevuegården")
grab_station(line, "Malmö Gamlegård")
...
grab_station(line, "Malmö Limhamns torg")
grab_station(line, "Malmö Stranden")
grab_station(line, "Malmö Strandgatan")
grab_station(line, "Malmö Sibbarp")
grab_route(line)
grab_directions(line)

line = Line.objects.create(name="35")
grab_station(line, "Malmö C")
grab_station(line, "Malmö Djäknegatan")
grab_station(line, "Malmö Studentgatan")
grab_station(line, "Malmö Konserthuset")
...
grab_station(line, "Malmö Möllevångstorget")
grab_station(line, "Malmö Södervärn")
grab_station(line, "Malmö Rolfsgatan")
grab_station(line, "Malmö Sofielund")
grab_station(line, "Malmö Lönngården")
grab_station(line, "Malmö Persborgs station")
grab_station(line, "Malmö Persborgstorget")
grab_station(line, "Malmö Örtagården")
grab_station(line, "Malmö Bennets väg")
grab_station(line, "Malmö Rosengård")
grab_station(line, "Malmö von Lingens väg")
grab_station(line, "Malmö Kryddgården")
grab_station(line, "Malmö Thomsons väg")
grab_route(line)
grab_directions(line)
